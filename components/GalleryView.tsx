...
export default function GalleryView() {
    ...
    const analyzeImage = async () => {
        ...
        try {
            ...
            const result = await detectRoadDamageYolo(selectedImage);
                    ...
                    <View style={styles.infoBlock}>
                        <View
                            ...
                            <ThemedText style={styles.howItWorksText}>
                                RoadRage - додаток для розпізнавання пошкоджень дорожнього полотна за допомогою штучного
                                інтелекту.
                            </ThemedText>
                            <ThemedText style={styles.howItWorksText}>
                                Оберіть фото з галереї, щоб проаналізувати стан дорожнього покриття. Увесь інтерфейс
                                оформлений у темній темі для зручності вночі.
                            </ThemedText>
                        </View>
                        ...
                        <View
                            ...
                            <ThemedText style={styles.howItWorksText}>
                                • Не використовуйте фото з сильними фільтрами чи обробкою - це може вплинути на якість
                                аналізу.
                            </ThemedText>
                        </View>
                    </View>
